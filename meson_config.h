...
/* HACK: These are provided by meson */
#mesondefine BINDIR
#mesondefine DATADIR
#mesondefine DOCDIR
...
#mesondefine HAVE_NCURSES_CURSES_H

/* Define to 1 if you have the <ncurses.h> header file. */
#mesondefine HAVE_NCURSES_H

/* Define to 1 if you have the <ncurses/term.h> header file. */
#mesondefine HAVE_NCURSES_TERM_H
...
#mesondefine HAVE_SIGINFO_H

/* Define to 1 if you have the <spawn.h> header file. */
#mesondefine HAVE_SPAWN_H
...
#mesondefine HAVE_STRUCT_STAT_ST_CTIME_NSEC
...
#mesondefine TPARM_SOLARIS_KLUDGE

/* Perform string translations with gettext */
#mesondefine USE_GETTEXT
